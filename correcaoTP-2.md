...
- Refatoração 3:   
  - Critério 1:  Ok 
  - Critério 2:  NOk - O método ValorTotalCompra::calcularTotalCompra() continua
    tendo variáveis temporárias em sua implementação. Não foi passada referência
    para a classe de origem do método-objeto. -60 pontos.
  - Critério 3:  Ok 
